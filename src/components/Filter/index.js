    ...
    <ContainerFilter>
      ...
      <ContainerValue>
        ...
        <StyledSlider
          ...
          min={1}
          max={6000}
          ariaValuetext={(state) => `Thumb value ${setTrackValue(state.valueNow)}`}
          renderThumb={(props, state) => <FilterThumb {...props}>{setThumbValue(state.valueNow)}</FilterThumb>}
          renderTrack={(props, state) => <FilterTrack {...props} index={state.index} />}
          pearling
          minDistance={100}
        />
      </ContainerValue>
